...
export const metadata: Metadata = {
  title: `FAQ — DeepMirror`,
  description: `Frequently asked questions about DeepMirror.`,
};
  ...
  return (
    <>
      ...
      <main className="flex-1 mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="text-text-secondary mb-8">Find answers to common questions about DeepMirror.</p>
