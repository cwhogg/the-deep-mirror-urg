...
export const metadata: Metadata = {
  title: `Blog — DeepMirror`,
  description: `Latest articles, tips, and guides from DeepMirror.`,
};
  ...
  return (
    <>
      ...
      <main className="flex-1 mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="text-text-secondary mb-8">Latest articles and guides from DeepMirror.</p>
